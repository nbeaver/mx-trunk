...
#define MXT_NUVANT_EZSTAT_AINPUT_FUEL_CELL_CURRENT			1
#define MXT_NUVANT_EZSTAT_AINPUT_FUEL_CELL_VOLTAGE_DROP			2
#define MXT_NUVANT_EZSTAT_AINPUT_CURRENT_FEEDBACK_RESISTOR_VOLTAGE	3
