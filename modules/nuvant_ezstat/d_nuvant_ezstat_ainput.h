...
#define MXU_NUVANT_EZSTAT_AINPUT_TYPE_LENGTH		40

#define MXT_NUVANT_EZSTAT_AINPUT_POTENTIOSTAT_CURRENT			1
#define MXT_NUVANT_EZSTAT_AINPUT_GALVANOSTAT_CURRENT			2
#define MXT_NUVANT_EZSTAT_AINPUT_FUEL_CELL_VOLTAGE_DROP			3
#define MXT_NUVANT_EZSTAT_AINPUT_CURRENT_FEEDBACK_RESISTOR_VOLTAGE	4
