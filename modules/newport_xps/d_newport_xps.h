...
#define MXF_NEWPORT_XPS_MOTOR_DEBUG_MOVE		0x1000
...
#define MXLV_NEWPORT_XPS_USER_TRAVEL_LIMITS			88009
#define MXLV_NEWPORT_XPS_RAW_USER_TRAVEL_LIMITS			88010
#define MXLV_NEWPORT_XPS_USER_TRAVEL_LIMITS_GUARD_BAND		88011
#define MXLV_NEWPORT_XPS_RAW_USER_TRAVEL_LIMITS_GUARD_BAND	88012
...
#define MXD_NEWPORT_XPS_MOTOR_STANDARD_FIELDS \
  ...
  {-1, -1, "newport_xps_motor_flags", MXFT_HEX, NULL, 0, {0}, \
	...
	{0}, NULL, (MXFF_IN_DESCRIPTION | MXFF_READ_ONLY) }, \
  \
  {-1, -1, "move_timeout", MXFT_DOUBLE, NULL, 0, {0}, \
	MXF_REC_TYPE_STRUCT, offsetof(MX_NEWPORT_XPS_MOTOR, move_timeout), \
  ...
  {MXLV_NEWPORT_XPS_RAW_USER_TRAVEL_LIMITS, -1, "raw_user_travel_limits", \
	...
	{sizeof(double)}, NULL, 0 }, \
  \
  {MXLV_NEWPORT_XPS_USER_TRAVEL_LIMITS_GUARD_BAND, -1, \
