...
typedef struct {
	...
	MX_EPICS_PV inpos_pv;
	MX_EPICS_PV rqspos_pv;

} MX_EPICS_PMAC_BIOCAT_MOTOR;
...
#define MXD_EPICS_PMAC_BIOCAT_STANDARD_FIELDS \
  {-1, -1, "beamline_name", MXFT_STRING, NULL, 1, {MXU_EPICS_PVNAME_LENGTH}, \
	MXF_REC_TYPE_STRUCT, \
		offsetof(MX_EPICS_PMAC_BIOCAT_MOTOR, beamline_name), \
	{sizeof(char)}, NULL, MXFF_IN_DESCRIPTION}, \
  \
  {-1, -1, "assembly_name", MXFT_STRING, NULL, 1, {MXU_EPICS_PVNAME_LENGTH}, \
	MXF_REC_TYPE_STRUCT, \
		offsetof(MX_EPICS_PMAC_BIOCAT_MOTOR, assembly_name), \
	{sizeof(char)}, NULL, (MXFF_IN_DESCRIPTION | MXFF_IN_SUMMARY)}, \
  \
  {-1, -1, "calib_name", MXFT_STRING, NULL, 1, {MXU_EPICS_PVNAME_LENGTH}, \
	MXF_REC_TYPE_STRUCT, offsetof(MX_EPICS_PMAC_BIOCAT_MOTOR, calib_name), \
	{sizeof(char)}, NULL, MXFF_IN_DESCRIPTION}, \
  \
  {-1, -1, "dpram_name", MXFT_STRING, NULL, 1, {MXU_EPICS_PVNAME_LENGTH}, \
	MXF_REC_TYPE_STRUCT, offsetof(MX_EPICS_PMAC_BIOCAT_MOTOR, dpram_name), \
	{sizeof(char)}, NULL, MXFF_IN_DESCRIPTION}, \
  \
  {-1, -1, "device_name", MXFT_STRING, NULL, 1, {MXU_EPICS_PVNAME_LENGTH}, \
	MXF_REC_TYPE_STRUCT, \
		offsetof(MX_EPICS_PMAC_BIOCAT_MOTOR, device_name), \
	{sizeof(char)}, NULL, (MXFF_IN_DESCRIPTION | MXFF_IN_SUMMARY)}
