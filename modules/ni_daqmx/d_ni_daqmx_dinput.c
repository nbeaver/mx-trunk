...
MX_RECORD_FUNCTION_LIST mxd_ni_daqmx_dinput_record_function_list = {
	...
	mxd_ni_daqmx_dinput_finish_record_initialization,
	NULL,
	NULL,
	mxd_ni_daqmx_dinput_open,
	mxd_ni_daqmx_dinput_close,
};
...
MX_EXPORT mx_status_type
mxd_ni_daqmx_dinput_finish_record_initialization( MX_RECORD *record )
{
...
MX_EXPORT mx_status_type
mxd_ni_daqmx_dinput_close( MX_RECORD *record )
{
	static const char fname[] = "mxd_ni_daqmx_dinput_close()";
