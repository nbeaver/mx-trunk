...
MX_API mx_status_type mxd_pcstep_print_structure( FILE *file,
						MX_RECORD *record );
MX_API mx_status_type mxd_pcstep_read_parms_from_hardware(
						MX_RECORD *record );
MX_API mx_status_type mxd_pcstep_write_parms_to_hardware(
						MX_RECORD *record );
MX_API mx_status_type mxd_pcstep_open( MX_RECORD *record );
MX_API mx_status_type mxd_pcstep_close( MX_RECORD *record );
...
extern mx_length_type mxd_pcstep_num_record_fields;
