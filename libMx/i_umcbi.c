...
MX_RECORD_FUNCTION_LIST mxi_umcbi_record_function_list = {
	mxi_umcbi_initialize_type,
	mxi_umcbi_create_record_structures,
	mxi_umcbi_finish_record_initialization,
	mxi_umcbi_delete_record,
	NULL,
	mxi_umcbi_read_parms_from_hardware,
	mxi_umcbi_write_parms_to_hardware,
	mxi_umcbi_open,
	mxi_umcbi_close
};
...
mxi_umcbi_initialize_type( long type )
{
	/* Nothing needed here. */
...
MX_EXPORT mx_status_type
mxi_umcbi_delete_record( MX_RECORD *record )
{
        if ( record == NULL ) {
                return MX_SUCCESSFUL_RESULT;
        }
...
MX_EXPORT mx_status_type
mxi_umcbi_read_parms_from_hardware( MX_RECORD *record )
{
	return MX_SUCCESSFUL_RESULT;
}

MX_EXPORT mx_status_type
mxi_umcbi_write_parms_to_hardware( MX_RECORD *record )
{
	return MX_SUCCESSFUL_RESULT;
}
...
MX_EXPORT mx_status_type
mxi_umcbi_num_input_bytes_available( MX_GENERIC *generic, int *input_available )
{
