 ...
 *--------------------------------------------------------------------------
 *
 * Copyright 2002-2003, 2015-2016, 2020, 2022 Illinois Institute of Technology
 *
...
mxd_adsc_two_theta_finish_record_initialization( MX_RECORD *record )
{
	...
	MX_MOTOR *motor = NULL;
	MX_ADSC_TWO_THETA *adsc_two_theta = NULL;
...
mxd_adsc_two_theta_print_motor_structure( FILE *file, MX_RECORD *record )
{
	...
	MX_MOTOR *motor = NULL;
	MX_RECORD *height_motor_record = NULL;
	MX_MOTOR *height_motor = NULL;
	MX_ADSC_TWO_THETA *adsc_two_theta = NULL;
