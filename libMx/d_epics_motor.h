...
MX_API mx_status_type mxd_epics_motor_find_home_position( MX_MOTOR *motor );
...
MX_API mx_status_type mxd_epics_motor_simultaneous_start(
...
extern mx_length_type mxd_epics_motor_num_record_fields;
