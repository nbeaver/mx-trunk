...
#define MXS_SQ_ENERGY_MCS_MAX_MOTORS			8

#define MXS_SQ_ENERGY_MCS_NUM_PREMOVE_MEASUREMENTS	2

#define MXS_SQ_ENERGY_MCS_ARRAY_BLOCK_SIZE		10

typedef struct {
	double *motor_position_array[ MXS_SQ_ENERGY_MCS_MAX_MOTORS ];
	void *extension_ptr;
	...
	double real_start_position[ MXS_SQ_ENERGY_MCS_MAX_MOTORS ];
	double real_end_position[ MXS_SQ_ENERGY_MCS_MAX_MOTORS ];

	double backlash_position[ MXS_SQ_ENERGY_MCS_MAX_MOTORS ];
} MX_ENERGY_MCS_QUICK_SCAN;

MX_API mx_status_type mxs_energy_mcs_quick_scan_initialize_type( long type );
...
MX_API mx_status_type mxs_energy_mcs_quick_scan_finish_record_initialization(
							MX_RECORD *record );
MX_API mx_status_type mxs_energy_mcs_quick_scan_delete_record(
							MX_RECORD *record );
...
extern mx_status_type mxs_energy_mcs_quick_scan_get_pointers( MX_SCAN *scan,
				MX_QUICK_SCAN **quick_scan,
				MX_ENERGY_MCS_QUICK_SCAN **mcs_quick_scan,
