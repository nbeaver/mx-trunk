...
MX_RECORD_FUNCTION_LIST mxd_keithley2600_ainput_record_function_list = {
	...
	NULL,
	NULL,
	mxd_keithley2600_ainput_special_processing_setup
};
...
mxd_keithley2600_ainput_process_function( void *, void *, void *, int );
...
MX_EXPORT mx_status_type
mxd_keithley2600_ainput_special_processing_setup( MX_RECORD *record )
{
	static const char fname[] =
		"mxd_keithley2600_ainput_special_processing_setup()";
	...
	for ( i = 0; i < record->num_record_fields; i++ ) {
		...
		case MXLV_KEITHLEY2600_AINPUT_SIGNAL_TYPE:
			record_field->process_function
				= mxd_keithley2600_ainput_process_function;
			break;
		default:
			break;
		}
...
static mx_status_type
mxd_keithley2600_ainput_process_function( void *record_ptr,
					...
					int operation )
{
	...
	case MX_PROCESS_PUT:
		...
		case MXLV_KEITHLEY2600_AINPUT_SIGNAL_TYPE:
			 ...
			 * all that is needed.
			 */
			mx_status = mxd_keithley2600_ainput_open( record );
			break;
		default:
			MX_DEBUG( 1,
