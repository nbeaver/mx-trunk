...
typedef struct {
	...
	MX_NETWORK_FIELD asynchronous_capture_nf;
	MX_NETWORK_FIELD asynchronous_circular_nf;
	...
	MX_NETWORK_FIELD master_clock_nf;
...
MX_API mx_status_type mxd_network_vinput_asynchronous_capture(
							MX_VIDEO_INPUT * );
