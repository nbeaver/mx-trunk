...
/* FIXME: Prototyping strptime() here should not be necessary.
 *   For Cygwin, defining __XSI_VISIBLE should provide a definition
 *   of strptime().  But doing that has other unpleasant side effects.
 *   For Hurd, who knows?
 */
