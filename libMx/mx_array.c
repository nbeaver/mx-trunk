			...
			mx_bool_type do_byteswap )
{
	...
	case MXFT_INT8:
		...
		for ( i = 0; i < num_elements; i++ ) {
		    int8_dest_vector[i] = (int8_t) int16_src_vector[i];
		}
		break;
	    case MXFT_UINT16:
		...
		for ( i = 0; i < num_elements; i++ ) {
		    int8_dest_vector[i] = (int8_t) uint16_src_vector[i];
		}
		break;
	    case MXFT_INT32:
		...
		for ( i = 0; i < num_elements; i++ ) {
		    int8_dest_vector[i] = (int8_t) int32_src_vector[i];
		}
		break;
	    case MXFT_UINT32:
		...
		for ( i = 0; i < num_elements; i++ ) {
		    int8_dest_vector[i] = (int8_t) uint32_src_vector[i];
		}
		break;
	    case MXFT_INT64:
		...
		for ( i = 0; i < num_elements; i++ ) {
		    int8_dest_vector[i] = (int8_t) int64_src_vector[i];
		}
		break;
	    case MXFT_UINT64:
		...
		for ( i = 0; i < num_elements; i++ ) {
		    int8_dest_vector[i] = (int8_t) uint64_src_vector[i];
		}
		break;
	    case MXFT_FLOAT:
		...
		for ( i = 0; i < num_elements; i++ ) {
		    int8_dest_vector[i] = (int8_t) float_src_vector[i];
		}
		break;
	    case MXFT_DOUBLE:
	...
	case MXFT_FLOAT:
		...
		for ( i = 0; i < num_elements; i++ ) {
		    float_dest_vector[i] = (float) int8_src_vector[i];
		}
		break;
	    case MXFT_UINT8:
		uint8_src_vector = src_vector;
		...
		for ( i = 0; i < num_elements; i++ ) {
		    float_dest_vector[i] = (float) uint8_src_vector[i];
		}
		break;
	    case MXFT_INT16:
		int16_src_vector = src_vector;
		...
		for ( i = 0; i < num_elements; i++ ) {
		    float_dest_vector[i] = (float) int16_src_vector[i];
		}
		break;
	    case MXFT_UINT16:
		uint16_src_vector = src_vector;
		...
		for ( i = 0; i < num_elements; i++ ) {
		    float_dest_vector[i] = (float) uint16_src_vector[i];
		}
		break;
	    case MXFT_INT32:
		int32_src_vector = src_vector;
		...
		for ( i = 0; i < num_elements; i++ ) {
		    float_dest_vector[i] = (float) int32_src_vector[i];
		}
		break;
	    case MXFT_UINT32:
		uint32_src_vector = src_vector;
		...
		for ( i = 0; i < num_elements; i++ ) {
		    float_dest_vector[i] = (float) uint32_src_vector[i];
		}
		break;
	    case MXFT_INT64:
		int64_src_vector = src_vector;
		...
		for ( i = 0; i < num_elements; i++ ) {
		    float_dest_vector[i] = (float) int64_src_vector[i];
		}
		break;
	    case MXFT_UINT64:
		uint64_src_vector = src_vector;
		...
		for ( i = 0; i < num_elements; i++ ) {
		    float_dest_vector[i] = (float) uint64_src_vector[i];
		}
		break;
	    case MXFT_FLOAT:
		memmove( dest_vector, src_vector, bytes_to_copy );
