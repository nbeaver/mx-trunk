...
{"pmac_int32",     MXV_PMA_INT32,     MXV_PMAC,          MXR_VARIABLE,
				&mxv_pmac_record_function_list,
				&mxv_pmac_variable_function_list,
				NULL,
				&mxv_pmac_int32_num_record_fields,
				&mxv_pmac_int32_rfield_def_ptr},

{"pmac_uint32",    MXV_PMA_UINT32,    MXV_PMAC,          MXR_VARIABLE,
				&mxv_pmac_record_function_list,
				&mxv_pmac_variable_function_list,
				NULL,
				&mxv_pmac_uint32_num_record_fields,
				&mxv_pmac_uint32_rfield_def_ptr},
...
{"spec_int8",      MXV_SPEC_INT8,     MXV_SPEC, MXR_VARIABLE,
				&mxv_spec_property_record_function_list,
				&mxv_spec_property_variable_function_list,
				NULL,
				&mxv_spec_int8_num_record_fields,
				&mxv_spec_int8_rfield_def_ptr},

{"spec_uint8",     MXV_SPEC_UINT8,    MXV_SPEC,  MXR_VARIABLE,
				&mxv_spec_property_record_function_list,
				&mxv_spec_property_variable_function_list,
				NULL,
				&mxv_spec_uint8_num_record_fields,
				&mxv_spec_uint8_rfield_def_ptr},

{"spec_int16",      MXV_SPEC_INT16,    MXV_SPEC,  MXR_VARIABLE,
				&mxv_spec_property_record_function_list,
				&mxv_spec_property_variable_function_list,
				NULL,
				&mxv_spec_int16_num_record_fields,
				&mxv_spec_int16_rfield_def_ptr},

{"spec_uint16",     MXV_SPEC_UINT16,    MXV_SPEC, MXR_VARIABLE,
				&mxv_spec_property_record_function_list,
				&mxv_spec_property_variable_function_list,
				NULL,
				&mxv_spec_uint16_num_record_fields,
				&mxv_spec_uint16_rfield_def_ptr},

{"spec_int32",      MXV_SPEC_INT32,     MXV_SPEC,   MXR_VARIABLE,
				&mxv_spec_property_record_function_list,
				&mxv_spec_property_variable_function_list,
				NULL,
				&mxv_spec_int32_num_record_fields,
				&mxv_spec_int32_rfield_def_ptr},

{"spec_uint32",     MXV_SPEC_UINT32,    MXV_SPEC,   MXR_VARIABLE,
				&mxv_spec_property_record_function_list,
				&mxv_spec_property_variable_function_list,
				NULL,
				&mxv_spec_uint32_num_record_fields,
				&mxv_spec_uint32_rfield_def_ptr},
