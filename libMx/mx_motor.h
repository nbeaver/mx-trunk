 ...
 *-------------------------------------------------------------------------
 *
 * Copyright 1999-2008, 2010, 2013-2018, 2020, 2022
...
#define MXSF_MTR_DISABLED_BY_MX			0x100000
#define MXSF_MTR_TIMED_OUT			0x200000
#define MXSF_MTR_WOULD_EXCEED_LIMIT		0x400000
#define MXSF_MTR_ILLEGAL_ARGUMENT		0x800000
...
#define MXLV_MTR_RAW_DESTINATION			1001
#define MXLV_MTR_RAW_POSITION				1002
#define MXLV_MTR_RAW_SET_POSITION			1003
#define MXLV_MTR_BUSY					1004
#define MXLV_MTR_DESTINATION				1005
#define MXLV_MTR_POSITION				1006
#define MXLV_MTR_SET_POSITION				1007
#define MXLV_MTR_RELATIVE_MOVE				1008
#define MXLV_MTR_TWEAK_DISTANCE				1009
#define MXLV_MTR_TWEAK_FORWARD				1010
#define MXLV_MTR_TWEAK_REVERSE				1011
#define MXLV_MTR_PREDICTED_POSITION			1012
#define MXLV_MTR_FOLLOWING_ERROR			1013
#define MXLV_MTR_USE_INTERNAL_POSITION_OFFSET		1014
#define MXLV_MTR_INTERNAL_POSITION_OFFSET		1015
#define MXLV_MTR_BACKLASH_CORRECTION			1016
#define MXLV_MTR_SOFT_ABORT				1017
#define MXLV_MTR_IMMEDIATE_ABORT			1018
#define MXLV_MTR_NEGATIVE_LIMIT_HIT			1019
#define MXLV_MTR_POSITIVE_LIMIT_HIT			1020
#define MXLV_MTR_RAW_HOME_COMMAND			1021
#define MXLV_MTR_HOME_SEARCH				1022
#define MXLV_MTR_HOME_SEARCH_TYPE			1023
#define MXLV_MTR_LIMIT_SWITCH_AS_HOME_SWITCH		1024
#define MXLV_MTR_CONSTANT_VELOCITY_MOVE			1025
#define MXLV_MTR_SPEED					1026
#define MXLV_MTR_BASE_SPEED				1027
#define MXLV_MTR_MAXIMUM_SPEED				1028
#define MXLV_MTR_CURRENT_SPEED				1029
#define MXLV_MTR_ACCELERATION_TYPE			1030
#define MXLV_MTR_RAW_ACCELERATION_PARAMETERS		1031
#define MXLV_MTR_ACCELERATION_TIME			1032
#define MXLV_MTR_ACCELERATION_DISTANCE			1033
#define MXLV_MTR_SPEED_CHOICE_PARAMETERS		1034
#define MXLV_MTR_SAVE_SPEED				1035
#define MXLV_MTR_RESTORE_SPEED				1036
#define MXLV_MTR_SYNCHRONOUS_MOTION_MODE		1037
#define MXLV_MTR_COMPUTE_EXTENDED_SCAN_RANGE		1038
#define MXLV_MTR_COMPUTE_PSEUDOMOTOR_POSITION		1039
#define MXLV_MTR_COMPUTE_REAL_POSITION			1040
#define MXLV_MTR_GET_REAL_MOTOR_FROM_PSEUDOMOTOR	1041
#define MXLV_MTR_GET_STATUS				1042
#define MXLV_MTR_GET_EXTENDED_STATUS			1043
#define MXLV_MTR_GET_RAW_STATUS				1044
#define MXLV_MTR_GET_LATCHED_STATUS			1045
#define MXLV_MTR_BUSY_START_INTERVAL_ENABLED		1046
#define MXLV_MTR_BUSY_START_INTERVAL			1047
#define MXLV_MTR_LAST_START_TIME			1048
#define MXLV_MTR_SAVE_START_POSITIONS			1049
#define MXLV_MTR_USE_START_POSITIONS			1050
#define MXLV_MTR_TRIGGERED_MOVE_DESTINATION		1051
#define MXLV_MTR_TRIGGER_MOVE				1052
#define MXLV_MTR_TRIGGER_MODE				1053
#define MXLV_MTR_WINDOW_IS_AVAILABLE			1054
#define MXLV_MTR_USE_WINDOW				1055
#define MXLV_MTR_WINDOW					1056
#define MXLV_MTR_NUM_ESTIMATED_MOVE_POSITIONS		1057
#define MXLV_MTR_ESTIMATED_MOVE_POSITIONS		1058
#define MXLV_MTR_ESTIMATED_MOVE_DURATIONS		1059
#define MXLV_MTR_TOTAL_ESTIMATED_MOVE_DURATION		1060
...
#define MX_STEPPER_MOTOR_STANDARD_FIELDS \
  {MXLV_MTR_RAW_DESTINATION, -1, "raw_destination", MXFT_LONG, NULL, 0, {0}, \
	MXF_REC_CLASS_STRUCT, offsetof(MX_MOTOR, raw_destination.stepper), \
	{0}, NULL, 0}, \
  \
  {MXLV_MTR_RAW_POSITION, -1, "raw_position", MXFT_LONG, NULL, 0, {0}, \
  ...
  {-1, -1, "raw_move_deadband", MXFT_LONG, NULL, 0, {0}, \
	...
	{0}, NULL, MXFF_IN_DESCRIPTION}, \
  \
  {MXLV_MTR_RAW_SET_POSITION, -1, "raw_set_position", MXFT_LONG, NULL, 0, {0}, \
	MXF_REC_CLASS_STRUCT, offsetof(MX_MOTOR, raw_set_position.stepper), \
	{0}, NULL, 0}

#define MX_ANALOG_MOTOR_STANDARD_FIELDS \
  {MXLV_MTR_RAW_DESTINATION, -1, "raw_destination", MXFT_DOUBLE, NULL, 0, {0}, \
	MXF_REC_CLASS_STRUCT, offsetof(MX_MOTOR, raw_destination.analog), \
	{0}, NULL, 0}, \
  \
  {MXLV_MTR_RAW_POSITION, -1, "raw_position", MXFT_DOUBLE, NULL, 0, {0}, \
  ...
  {-1, -1, "raw_move_deadband", MXFT_DOUBLE, NULL, 0, {0}, \
	...
	{0}, NULL, MXFF_IN_DESCRIPTION}, \
  \
  {MXLV_MTR_RAW_SET_POSITION, -1, \
	  		"raw_set_position", MXFT_DOUBLE, NULL, 0, {0}, \
