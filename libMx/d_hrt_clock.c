...
mxd_hrt_clock_get_pointers( MX_CLOCK *mx_clock,
			...
			const char *calling_fname )
{
	...
	if ( mx_clock->record->mx_type != MXT_CLK_HRT_CLOCK ) {
...
MX_EXPORT mx_status_type
mxd_hrt_clock_get_timespec( MX_CLOCK *mx_clock )
{
	...
	mx_status = mxd_hrt_clock_get_pointers( mx_clock, &hrt_clock, fname );
