...
typedef struct {
	...
	int device_descriptor[MX_NUM_GPIB_ADDRESSES];
} MX_NI488;
...
MX_API mx_status_type mxi_ni488_open_device( MX_GPIB *gpib, int address );
MX_API mx_status_type mxi_ni488_close_device( MX_GPIB *gpib, int address );
...
MX_API mx_status_type mxi_ni488_remote_enable( MX_GPIB *gpib, int address );
MX_API mx_status_type mxi_ni488_go_to_local( MX_GPIB *gpib, int address );
MX_API mx_status_type mxi_ni488_trigger( MX_GPIB *gpib, int address );
MX_API mx_status_type mxi_ni488_wait_for_service_request( MX_GPIB *gpib,
						double timeout );
MX_API mx_status_type mxi_ni488_serial_poll( MX_GPIB *gpib, int address,
...
#define MXI_NI488_STANDARD_FIELDS \
  ...
  \
  {-1, -1, "board_descriptor", MXFT_INT, NULL, 0, {0}, \
	MXF_REC_TYPE_STRUCT, offsetof(MX_NI488, board_descriptor), \
	{0}, NULL, 0}, \
  \
  {-1, -1, "device_descriptor", MXFT_INT, NULL, 1, {MX_NUM_GPIB_ADDRESSES}, \
