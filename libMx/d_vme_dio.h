...
MX_API mx_status_type mxd_vme_din_initialize_type( long type );
MX_API mx_status_type mxd_vme_din_create_record_structures(
							MX_RECORD *record );
MX_API mx_status_type mxd_vme_din_finish_record_initialization(
							MX_RECORD *record );
MX_API mx_status_type mxd_vme_din_delete_record( MX_RECORD *record );
MX_API mx_status_type mxd_vme_din_read_parms_from_hardware(
							MX_RECORD *record );
MX_API mx_status_type mxd_vme_din_write_parms_to_hardware(
							MX_RECORD *record );
MX_API mx_status_type mxd_vme_din_open( MX_RECORD *record );
MX_API mx_status_type mxd_vme_din_close( MX_RECORD *record );
...
MX_API mx_status_type mxd_vme_dout_initialize_type( long type );
MX_API mx_status_type mxd_vme_dout_create_record_structures(
							MX_RECORD *record );
MX_API mx_status_type mxd_vme_dout_finish_record_initialization(
							MX_RECORD *record );
MX_API mx_status_type mxd_vme_dout_delete_record( MX_RECORD *record );
MX_API mx_status_type mxd_vme_dout_read_parms_from_hardware(
							MX_RECORD *record );
MX_API mx_status_type mxd_vme_dout_write_parms_to_hardware(
							MX_RECORD *record );
MX_API mx_status_type mxd_vme_dout_open( MX_RECORD *record );
MX_API mx_status_type mxd_vme_dout_close( MX_RECORD *record );
MX_API mx_status_type mxd_vme_dout_read( MX_DIGITAL_OUTPUT *doutput );
