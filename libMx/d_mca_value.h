...
#define MXT_MCA_VALUE_LIVE_TIME_CORRECTED_ROI_INTEGRAL		5
#define MXT_MCA_VALUE_LIVE_TIME_CORRECTED_SOFT_ROI_INTEGRAL	6
#define MXT_MCA_VALUE_INPUT_COUNT_RATE				7
#define MXT_MCA_VALUE_OUTPUT_COUNT_RATE				8
#define MXT_MCA_VALUE_RATE_CORRECTED_ROI_INTEGRAL		9
#define MXT_MCA_VALUE_RATE_CORRECTED_SOFT_ROI_INTEGRAL		10
