 ...
 *-------------------------------------------------------------------------
 *
 * Copyright 1999-2001, 2003-2004, 2007, 2010, 2020
...
MX_API_PRIVATE mx_status_type mxs_list_scan_initialize_driver(
							MX_DRIVER *driver );
...
MX_API_PRIVATE mx_status_type mxs_list_scan_cleanup_after_scan_end(
							MX_SCAN *scan );
MX_API_PRIVATE mx_status_type mxs_list_scan_get_parameter( MX_SCAN *scan );
