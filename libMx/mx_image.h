...
#define MXT_IMAGE_NO_TRIGGER		MXT_DEV_NO_TRIGGER
#define MXT_IMAGE_INTERNAL_TRIGGER	MXT_DEV_INTERNAL_TRIGGER
#define MXT_IMAGE_EXTERNAL_TRIGGER	MXT_DEV_EXTERNAL_TRIGGER
#define MXT_IMAGE_DATABASE_TRIGGER	MXT_DEV_DATABASE_TRIGGER
#define MXT_IMAGE_MANUAL_TRIGGER	MXT_DEV_MANUAL_TRIGGER

#define MXT_IMAGE_EDGE_TRIGGER		MXT_DEV_EDGE_TRIGGER
#define MXT_IMAGE_LEVEL_TRIGGER		MXT_DEV_LEVEL_TRIGGER
