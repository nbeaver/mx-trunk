...
MX_API mx_status_type mxd_table_motor_find_home_position( MX_MOTOR *motor );
MX_API mx_status_type mxd_table_motor_constant_velocity_move( MX_MOTOR *motor );
MX_API mx_status_type mxd_table_motor_get_parameter( MX_MOTOR *motor );
MX_API mx_status_type mxd_table_motor_set_parameter( MX_MOTOR *motor );
