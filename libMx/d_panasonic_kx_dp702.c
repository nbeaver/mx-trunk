...
#define MXD_PANASONIC_KX_DP702_PTZ_DEBUG	TRUE
			...
			const char *calling_fname )
{
	...
	panasonic_kx_dp702_ptz_ptr = (MX_PANASONIC_KX_DP702_PTZ *)
					ptz->record->record_type_struct;

	if (panasonic_kx_dp702_ptz_ptr == (MX_PANASONIC_KX_DP702_PTZ *) NULL) {
		return mx_error( MXE_CORRUPT_DATA_STRUCTURE, fname,
	    "The MX_PANASONIC_KX_DP702_PTZ pointer for record '%s' is NULL.",
			ptz->record->name );
	}

	if ( panasonic_kx_dp702_ptz != (MX_PANASONIC_KX_DP702_PTZ **) NULL ) {
		*panasonic_kx_dp702_ptz = panasonic_kx_dp702_ptz_ptr;
	}

	kx_dp702_record = panasonic_kx_dp702_ptz_ptr->kx_dp702_record;
...
static mx_status_type
mxd_panasonic_kx_dp702_ptz_pan_tilt_drive_string( MX_RECORD *ptz_record,
					unsigned char *destination,
					size_t max_command_length,
					unsigned char *suffix )
{
	static const char fname[] =
			"mxd_panasonic_kx_dp702_ptz_pan_tilt_drive_string()";
...
mxd_panasonic_kx_dp702_ptz_create_record_structures( MX_RECORD *record )
{
        ...
        } panasonic_kx_dp702_ptz = (MX_PANASONIC_KX_DP702_PTZ *)
        ...
        record->record_type_struct = panasonic_kx_dp702_ptz;
        record->class_specific_function_list =
				&mxd_panasonic_kx_dp702_ptz_ptz_function_list;

        ptz->record = record;
	panasonic_kx_dp702_ptz->record = record;
...
mxd_panasonic_kx_dp702_ptz_command( MX_PAN_TILT_ZOOM *ptz )
{
	...
	mx_status = mxd_panasonic_kx_dp702_ptz_get_pointers( ptz,
					&panasonic_kx_dp702_ptz, &panasonic_kx_dp702, fname );
	...
	case MXF_PTZ_PAN_LEFT:
		mxd_panasonic_kx_dp702_ptz_pan_tilt_drive_string( ptz->record,
	...
	case MXF_PTZ_DRIVE_HOME:
		mxi_panasonic_kx_dp702_copy( command,
	...
	case MXF_PTZ_FOCUS_FAR:
		...
		mx_status = mxd_panasonic_kx_dp702_ptz_command( ptz );
	...
	default:
		return mx_error( MXE_ILLEGAL_ARGUMENT, fname,
			...
			"is not a known command type.",
				ptz->command, panasonic_kx_dp702_ptz->record->name );
		break;
	}

	/* Send the command. */

	mx_status = mxi_panasonic_kx_dp702_cmd( panasonic_kx_dp702,
					panasonic_kx_dp702_ptz->camera_number,
					command, NULL, 0, NULL );
...
mxd_panasonic_kx_dp702_ptz_get_status( MX_PAN_TILT_ZOOM *ptz )
{
	...
	/* FIXME: The Panasonic EVI-D100 says that the following command
...
{
	static const char fname[] = "mxd_panasonic_kx_dp702_ptz_get_parameter()";
...
{
	static const char fname[] = "mxd_panasonic_kx_dp702_ptz_set_parameter()";
...
#endif
		mx_status = mxi_panasonic_kx_dp702_value_string(
	...
	default:
		return mx_error( MXE_ILLEGAL_ARGUMENT, fname,
			...
			saved_parameter_type, panasonic_kx_dp702_ptz->record->name );
		break;
	}
